...
<body>
    ...
    <div>
        ...
        ADD:<asp:TextBox ID="txtEADD" runat="server"></asp:TextBox>
        TEL:<asp:TextBox ID="tel" runat="server"></asp:TextBox>
        ...
        ADD:<asp:TextBox ID="txtE_ADD" runat="server"></asp:TextBox>
        TEL:<asp:TextBox ID="_tel" runat="server"></asp:TextBox>
